...
**Data flow:**
1. `discover.py` — scans `~/.claude/projects/`, `~/.cursor/projects/`, `~/.codex/sessions/`, `~/.pi/agent/sessions/`, `~/.copilot/session-state/` → `SessionInfo` list
